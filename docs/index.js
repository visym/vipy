...
"vipy/data/places.html",
"vipy/data/lfw.html",
"vipy/data/msceleb.html",
"vipy/data/hmdb.html",
"vipy/data/vggface2.html",
"vipy/data/fddb.html",
"vipy/data/objectnet.html",
"vipy/data/meva.html",
"vipy/util.html",
"vipy/linalg.html",
...
"url":10,
"doc":"Replication of scipy.interpolate.interp1d with assume_sorted=True, and constant replication of boundary handling. Input must be sorted.",
"func":1
},
{
...
"url":11,
"doc":"Import the JSON string s as an  vipy.image.Image object. Args: encoded [bool]: If False, assume that the input is a native JSON object, and has not been encoded to a string This will perform a round trip such that im1  im2   im1 = vupy.image.RandomImage() im2 = vipy.image.Image.from_json(im1.json( assert im1  im2  ",
"func":1
},
{
...
"url":11,
"doc":"Return the EXIF meta-data in filename as a dictionary. Included non-base EXIF data if extended=True. Returns empty dictionary if no EXIF exists. Triggers download.",
"func":1
},
{
...
{
"ref":"vipy.image.Image.probability",
"url":11,
...
{
"ref":"vipy.image.ImageCategories",
"url":11,
"doc":"vipy ImageCategories class This class provides a representation of a vipy.image.ImageCategory with a multi-element category set. Valid constructors include all provided by vipy.image.ImageCategory with category as set or string   im = vipy.image.ImageCategories(filename='/path/to/dog_image.ext', category={'dog','canine'}) im = vipy.image.ImageCategories(array=dog_img, colorspace='rgb', category='dog')  "
},
{
"ref":"vipy.image.ImageCategories.cast",
"url":11,
"doc":"Typecast the conformal vipy.image object im as  vipy.image.Image . This is useful for downcasting  vipy.image.Scene or  vipy.image.ImageDetection down to an image.   ims = vipy.image.RandomScene() im = vipy.image.Image.cast(im)  ",
"func":1
},
{
"ref":"vipy.image.ImageCategories.from_json",
"url":11,
"doc":"Import the JSON string s as an  vipy.image.Image object. Args: encoded [bool]: If False, assume that the input is a native JSON object, and has not been encoded to a string This will perform a round trip such that im1  im2   im1 = vupy.image.RandomImage() im2 = vipy.image.Image.from_json(im1.json( assert im1  im2  ",
"func":1
},
{
"ref":"vipy.image.ImageCategories.json",
"url":11,
"doc":"",
"func":1
},
{
"ref":"vipy.image.ImageCategories.probability",
"url":11,
"doc":"Real valued probability for categorization, [0,1]",
"func":1
},
{
"ref":"vipy.image.ImageCategories.score",
"url":11,
"doc":"Real valued score for categorization, larger is better",
"func":1
},
{
"ref":"vipy.image.ImageCategories.nocategory",
"url":11,
"doc":"",
"func":1
},
{
"ref":"vipy.image.ImageCategories.categories",
"url":11,
"doc":"Add list [category1, category2,  .] or scored list [(category1, score1), (category2, score2),  .] as multi-categories",
"func":1
},
{
"ref":"vipy.image.ImageCategories.add_category",
"url":11,
"doc":"",
"func":1
},
{
"ref":"vipy.image.ImageCategories.remove_category",
"url":11,
"doc":"",
"func":1
},
{
"ref":"vipy.image.ImageCategories.category",
"url":11,
"doc":"Return or update the category",
"func":1
},
{
"ref":"vipy.image.ImageCategories.ranked_categories",
"url":11,
"doc":"Returned a ranked list of categories in order of decreasing score. Unscored categories are appended, highest score at index 0",
"func":1
},
{
"ref":"vipy.image.ImageCategories.scored_categories",
"url":11,
"doc":"",
"func":1
},
{
"ref":"vipy.image.ImageCategories.category_scores",
"url":11,
"doc":"",
"func":1
},
{
"ref":"vipy.image.ImageCategories.has_category",
"url":11,
"doc":"",
"func":1
},
{
"ref":"vipy.image.ImageCategories.label",
"url":11,
"doc":"Alias for category",
"func":1
},
{
"ref":"vipy.image.ImageCategories.sanitize",
"url":11,
"doc":"Remove all private keys from the attributes dictionary. The attributes dictionary is useful storage for arbitrary (key,value) pairs. However, this storage may contain sensitive information that should be scrubbed from the media before serialization. As a general rule, any key that is of the form '__keyname' prepended by two underscores is a private key. This is analogous to private or reserved attributes in the python lanugage. Users should reserve these keynames for those keys that should be sanitized and removed before any serialization of this object.   assert self.setattribute('__mykey', 1).sanitize().hasattribute('__mykey')  False  ",
"func":1
},
{
"ref":"vipy.image.ImageCategories.print",
"url":11,
"doc":"Print the representation of the image and return self with an optional sleep=n seconds Useful for debugging in long fluent chains.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.exif",
"url":11,
"doc":"Return the EXIF meta-data in filename as a dictionary. Included non-base EXIF data if extended=True. Returns empty dictionary if no EXIF exists. Triggers download.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.tile",
"url":11,
"doc":"Generate an image tiling. A tiling is a decomposition of an image into overlapping or non-overlapping rectangular regions. Args: tilewidth: [int] the image width of each tile tileheight: [int] the image height of each tile overlaprows: [int] the number of overlapping rows (height) for each tile overlapcols: [int] the number of overlapping width (width) for each tile Returns: A list of  vipy.image.Image objects such that each image is a single tile and the set of these tiles forms the original image Each image in the returned list contains the 'tile' attribute which encodes the crop used to create the tile.  note -  vipy.image.Image.tile can be undone using  vipy.image.Image.untile - The identity tiling is im.tile(im.widht(), im.height(), overlaprows=0, overlapcols=0) - Ragged tiles outside the image boundary are zero padded - All annotations are updated properly for each tile, when the source image is  vipy.image.Scene ",
"func":1
},
{
"ref":"vipy.image.ImageCategories.union",
"url":11,
"doc":"No-op for  vipy.image.Image ",
"func":1
},
{
"ref":"vipy.image.ImageCategories.untile",
"url":11,
"doc":"Undo an image tiling and recreate the original image.   tiles = im.tile(im.width()/2, im.height()/2, 0, 0) imdst = vipy.image.Image.untile(tiles) assert imdst  im   Args: imlist: this must be the output of  vipy.image.Image.tile Returns: A new  vipy.image.Image object reconstructed from the tiling, such that this is equivalent to the input to vipy.image.Image.tile  note All annotations are updated properly for each tile, when the source image is  vipy.image.Scene ",
"func":1
},
{
"ref":"vipy.image.ImageCategories.uncrop",
"url":11,
"doc":"Uncrop using provided bounding box and zeropad to shape=(Height, Width). An uncrop is the inverse operation for a crop, which preserves the cropped portion of the image in the correct location and replaces the rest with zeros out to shape.   im = vipy.image.RandomImage(128, 128) bb = vipy.geometry.BoundingBox(xmin=0, ymin=0, width=64, height=64) uncrop = im.crop(bb).uncrop(bb, shape=(128,128   Args: bb: [ vipy.geometry.BoundingBox ] the bounding box used to crop the image in self shape: [tuple] (height, width) of the uncropped image Returns: this  vipy.image.Image object with the pixels uncropped.  note NOT idempotent. This will generate different results if run more than once.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.splat",
"url":11,
"doc":"Replace pixels within boundingbox in self with pixels in im",
"func":1
},
{
"ref":"vipy.image.ImageCategories.store",
"url":11,
"doc":"Store the current image file as an attribute of this object. Useful for archiving an object to be fully self contained without any external references. -Remove this stored image using unstore() -Unpack this stored image and set up the filename using restore() -This method is more efficient than load() followed by pkl(), as it stores the encoded image as a byte string. -Useful for creating a single self contained object for distributed processing.   v  v.store().restore(v.filename(  ",
"func":1
},
{
"ref":"vipy.image.ImageCategories.unstore",
"url":11,
"doc":"Delete the currently stored image from store()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.restore",
"url":11,
"doc":"Save the currently stored image to filename, and set up filename",
"func":1
},
{
"ref":"vipy.image.ImageCategories.abspath",
"url":11,
"doc":"Change the path of the filename from a relative path to an absolute path (not relocatable)",
"func":1
},
{
"ref":"vipy.image.ImageCategories.relpath",
"url":11,
"doc":"Replace the filename with a relative path to parent (or current working directory if none)",
"func":1
},
{
"ref":"vipy.image.ImageCategories.canload",
"url":11,
"doc":"Return True if the image can be loaded successfully, useful for filtering bad links or corrupt images",
"func":1
},
{
"ref":"vipy.image.ImageCategories.dict",
"url":11,
"doc":"Return a python dictionary containing the relevant serialized attributes suitable for JSON encoding",
"func":1
},
{
"ref":"vipy.image.ImageCategories.loader",
"url":11,
"doc":"Lambda function to load an unsupported image filename to a numpy array. This lambda function will be executed during load and the result will be stored in self._array",
"func":1
},
{
"ref":"vipy.image.ImageCategories.load",
"url":11,
"doc":"Load image to cached private '_array' attribute. Args: ignoreErrors: [bool] If true, ignore any exceptions thrown during load and print the corresponding error messages. This is useful for loading images distributed without throwing exceptions when some images may be corrupted. In this case, the _array attribute will be None and  vipy.image.Image.isloaded will return false to determine if the image is loaded, which can be used to filter out corrupted images gracefully. verbose: [bool] If true, show additional useful printed output Returns: This  vipy.image.Image object with the pixels loaded in self._array as a numpy array.  note This loader supports any image file format supported by PIL. A custom loader can be added using  vipy.image.Image.loader .",
"func":1
},
{
"ref":"vipy.image.ImageCategories.download",
"url":11,
"doc":"Download URL to filename provided by constructor, or to temp filename. Args: ignoreErrors: [bool] If true, do not throw an exception if the download of the URL fails for some reason. Instead, print out a reason and return this image object. The function  vipy.image.Image.hasfilename will return false if the downloaded file does not exist and can be used to filter these failed downloads gracefully. timeout: [int] The timeout in seconds for an http or https connection attempt. See also [urllib.request.urlopen](https: docs.python.org/3/library/urllib.request.html). verbose: [bool] If true, output more helpful message. Returns: This  vipy.image.Image object with the URL downloaded to  vipy.image.Image.filename or to a  vipy.util.tempimage filename which can be retrieved with  vipy.image.Image.filename .",
"func":1
},
{
"ref":"vipy.image.ImageCategories.reload",
"url":11,
"doc":"Flush the image buffer to force reloading from file or URL",
"func":1
},
{
"ref":"vipy.image.ImageCategories.isloaded",
"url":11,
"doc":"Return True if  vipy.image.Image.load was successful in reading the image, or if the pixels are present in  vipy.image.Image.array .",
"func":1
},
{
"ref":"vipy.image.ImageCategories.channels",
"url":11,
"doc":"Return integer number of color channels",
"func":1
},
{
"ref":"vipy.image.ImageCategories.iscolor",
"url":11,
"doc":"Color images are three channel or four channel with transparency, float32 or uint8",
"func":1
},
{
"ref":"vipy.image.ImageCategories.istransparent",
"url":11,
"doc":"Transparent images are four channel color images with transparency, float32 or uint8. Return true if this image contains an alpha transparency channel",
"func":1
},
{
"ref":"vipy.image.ImageCategories.isgrey",
"url":11,
"doc":"Grey images are one channel, float32",
"func":1
},
{
"ref":"vipy.image.ImageCategories.isluminance",
"url":11,
"doc":"Luninance images are one channel, uint8",
"func":1
},
{
"ref":"vipy.image.ImageCategories.filesize",
"url":11,
"doc":"Return size of underlying image file, requires fetching metadata from filesystem",
"func":1
},
{
"ref":"vipy.image.ImageCategories.width",
"url":11,
"doc":"Return the width (columns) of the image in integer pixels.  note This triggers a  vipy.image.Image.load if the image is not already loaded.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.height",
"url":11,
"doc":"Return the height (rows) of the image in integer pixels.  note This triggers a  vipy.image.Image.load if the image is not already loaded.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.shape",
"url":11,
"doc":"Return the (height, width) or equivalently (rows, cols) of the image. Returns: A tuple (height=int, width=int) of the image.  note This triggers a  vipy.image.Image.load if the image is not already loaded.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.aspectratio",
"url":11,
"doc":"Return the aspect ratio of the image as (width/height) ratio. Returns: A float equivalent to ( vipy.image.Image.width /  vipy.image.Image.height )  note This triggers a  vipy.image.Image.load if the image is not already loaded.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.area",
"url":11,
"doc":"Return the area of the image as (width  height). Returns: An integer equivalent to ( vipy.image.Image.width   vipy.image.Image.height )  note This triggers a  vipy.image.Image.load if the image is not already loaded.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.centroid",
"url":11,
"doc":"Return the real valued center pixel coordinates of the image (col=x,row=y). The centroid is equivalent to half the  vipy.image.Image.shape . Returns: A tuple (column, row) of the floating point center of the image.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.centerpixel",
"url":11,
"doc":"Return the integer valued center pixel coordinates of the image (col=i,row=j) The centerpixel is equivalent to half the  vipy.image.Image.shape floored to the nearest integer pixel coordinate. Returns: A tuple (int(column), int(row of the integer center of the image.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.array",
"url":11,
"doc":"Replace self._array with provided numpy array Args: np_array: [numpy array] A new array to use as the pixel buffer for this image. copy: [bool] If true, copy the buffer using np.copy(), else use a reference to this buffer. Returns: - If np_array is not None, return the  vipy.image.Image object such that this object points to the provided numpy array as the pixel buffer - If np_array is None, then return the numpy array.  notes - If copy=False, then this  vipy.image.Image object will share the pixel buffer with the owner of np_array. Changes to pixels in this buffer will be shared. - If copy=True, then this will significantly slow down processing for large images. Use referneces wherevery possible.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.fromarray",
"url":11,
"doc":"Alias for  vipy.image.Image.array with copy=True. This will set new numpy array as the pixel buffer with a numpy array copy",
"func":1
},
{
"ref":"vipy.image.ImageCategories.tonumpy",
"url":11,
"doc":"Alias for  vipy.image.Image.numpy",
"func":1
},
{
"ref":"vipy.image.ImageCategories.numpy",
"url":11,
"doc":"Return a mutable numpy array for this  vipy.image.Image .  notes - This will always return a writeable array with the 'WRITEABLE' numpy flag set. This is useful for returning a mutable numpy array as needed while keeping the original non-mutable numpy array (e.g. loaded from a video or PIL) as the underlying pixel buffer for efficiency reasons. - Triggers a  vipy.image.Image.load if the pixel buffer has not been loaded - This will trigger a copy if the ['WRITEABLE' flag](https: numpy.org/doc/stable/reference/generated/numpy.ndarray.flags.html) is not set.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.channel",
"url":11,
"doc":"Return a cloned Image() object for the kth channel, or return an iterator over channels if k=None. Iterate over channels as single channel luminance images:   for c in self.channel(): print(c)   Return the kth channel as a single channel luminance image:   c = self.channel(k=0)  ",
"func":1
},
{
"ref":"vipy.image.ImageCategories.red",
"url":11,
"doc":"Return red channel as a cloned single channel  vipy.image.Image object. These are equivalent operations if the colorspace is 'rgb' or 'rgba':   self.red()  self.channel(0)   These are equivalent operations if the colorspace is 'bgr' or 'bgra':   self.red()  self.channel(3)    note OpenCV returns images in BGR colorspace. Use this method to always return the desired channel by color.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.green",
"url":11,
"doc":"Return green channel as a cloned single channel  vipy.image.Image object. These are equivalent operations if the colorspace is 'rgb' or 'rgba':   self.green()  self.channel(1)   These are equivalent operations if the colorspace is 'bgr' or 'bgra':   self.green()  self.channel(1)    note OpenCV returns images in BGR colorspace. Use this method to always return the desired channel by color.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.blue",
"url":11,
"doc":"Return blue channel as a cloned single channel  vipy.image.Image object. These are equivalent operations if the colorspace is 'rgb' or 'rgba':   self.vlue()  self.channel(2)   These are equivalent operations if the colorspace is 'bgr' or 'bgra':   self.blue()  self.channel(0)    note OpenCV returns images in BGR colorspace. Use this method to always return the desired channel by color.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.alpha",
"url":11,
"doc":"Return alpha (transparency) channel as a cloned single channel  vipy.image.Image object",
"func":1
},
{
"ref":"vipy.image.ImageCategories.zeros",
"url":11,
"doc":"Set the pixel buffer to all zeros of the same shape and datatype as this  vipy.image.Image object. These are equivalent operations for the resulting buffer shape:   import numpy as np np.zeros( (self.width(), self.height(), self.channels( )  self.zeros().array()   Returns: This  vipy.image.Image object.  note Triggers load() if the pixel buffer has not been loaded yet.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.pil",
"url":11,
"doc":"Convert vipy.image.Image to PIL Image. Returns: A [PIL image](https: pillow.readthedocs.io/en/stable/reference/Image.html) object, that shares the pixel buffer by reference",
"func":1
},
{
"ref":"vipy.image.ImageCategories.blur",
"url":11,
"doc":"Apply a Gaussian blur with Gaussian kernel radius=sigma to the pixel buffer. Args: sigma: [float >=0] The gaussian blur kernel radius. Returns: This  vipy.image.Image object with the pixel buffer blurred in place.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.torch",
"url":11,
"doc":"Convert the batch of 1 HxWxC images to a CxHxW torch tensor. Args: order: ['CHW', 'HWC', 'NCHW', 'NHWC']. The axis order of the torch tensor (channels, height, width) or (height, width, channels) or (1, channels, height, width) or (1, height, width, channels) Returns: A CxHxW or HxWxC or 1xCxHxW or 1xHxWxC [torch tensor](https: pytorch.org/docs/stable/tensors.html) that shares the pixel buffer of this image object by reference.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.fromtorch",
"url":11,
"doc":"Convert a 1xCxHxW or CxHxW torch tensor (or numpy array with torch channel order) to HxWxC numpy array, returns new  vipy.image.Image with inferred colorspace corresponding to data type in x",
"func":1
},
{
"ref":"vipy.image.ImageCategories.filename",
"url":11,
"doc":"Return or set image filename",
"func":1
},
{
"ref":"vipy.image.ImageCategories.url",
"url":11,
"doc":"Image URL and URL download properties",
"func":1
},
{
"ref":"vipy.image.ImageCategories.colorspace",
"url":11,
"doc":"Return or set the colorspace as ['rgb', 'rgba', 'bgr', 'bgra', 'hsv', 'float', 'grey', 'lum']",
"func":1
},
{
"ref":"vipy.image.ImageCategories.uri",
"url":11,
"doc":"Return the URI of the image object, either the URL or the filename, raise exception if neither defined",
"func":1
},
{
"ref":"vipy.image.ImageCategories.setattribute",
"url":11,
"doc":"Set element self.attributes[key]=value",
"func":1
},
{
"ref":"vipy.image.ImageCategories.setattributes",
"url":11,
"doc":"Set many attributes at once by providing a dictionary to be merged with current attributes",
"func":1
},
{
"ref":"vipy.image.ImageCategories.getattribute",
"url":11,
"doc":"Return the key k in the attributes dictionary (self.attributes) if present, else None",
"func":1
},
{
"ref":"vipy.image.ImageCategories.metadata",
"url":11,
"doc":"Return metadata associated with this image, stored in the attributes dictionary",
"func":1
},
{
"ref":"vipy.image.ImageCategories.clone",
"url":11,
"doc":"Create deep copy of object, flushing the original buffer if requested and returning the cloned object. Flushing is useful for distributed memory management to free the buffer from this object, and pass along a cloned object which can be used for encoding and will be garbage collected.  flushforward: copy the object, and set the cloned object array() to None. This flushes the video buffer for the clone, not the object  flushbackward: copy the object, and set the object array() to None. This flushes the video buffer for the object, not the clone.  flush: set the object array() to None and clone the object. This flushes the video buffer for both the clone and the object.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.flush",
"url":11,
"doc":"Alias for clone(flush=True), returns self not clone",
"func":1
},
{
"ref":"vipy.image.ImageCategories.resize",
"url":11,
"doc":"Resize the image buffer to (rows x cols) with bilinear interpolation. If rows or cols is provided, rescale image maintaining aspect ratio",
"func":1
},
{
"ref":"vipy.image.ImageCategories.resize_like",
"url":11,
"doc":"Resize image buffer to be the same size as the provided vipy.image.Image()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.rescale",
"url":11,
"doc":"Scale the image buffer by the given factor - NOT idempotent",
"func":1
},
{
"ref":"vipy.image.ImageCategories.maxdim",
"url":11,
"doc":"Resize image preserving aspect ratio so that maximum dimension of image = dim, or return maxdim()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.mindim",
"url":11,
"doc":"Resize image preserving aspect ratio so that minimum dimension of image = dim, or return mindim()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.mindimn",
"url":11,
"doc":"Frequently used shortcut for mindim(dim, interp='nearest')",
"func":1
},
{
"ref":"vipy.image.ImageCategories.zeropad",
"url":11,
"doc":"Pad image using np.pad constant by adding padwidth on both left and right , or padwidth=(left,right) for different pre/postpadding and padheight on top and bottom or padheight=(top,bottom) for different pre/post padding",
"func":1
},
{
"ref":"vipy.image.ImageCategories.zeropadlike",
"url":11,
"doc":"Zero pad the image balancing the border so that the resulting image size is (width, height)",
"func":1
},
{
"ref":"vipy.image.ImageCategories.meanpad",
"url":11,
"doc":"Pad image using np.pad constant=image mean by adding padwidth on both left and right , or padwidth=(left,right) for different pre/postpadding and padheight on top and bottom or padheight=(top,bottom) for different pre/post padding",
"func":1
},
{
"ref":"vipy.image.ImageCategories.alphapad",
"url":11,
"doc":"Pad image using alpha transparency by adding padwidth on both left and right , or padwidth=(left,right) for different pre/postpadding and padheight on top and bottom or padheight=(top,bottom) for different pre/post padding",
"func":1
},
{
"ref":"vipy.image.ImageCategories.minsquare",
"url":11,
"doc":"Crop image of size (HxW) to (min(H,W), min(H,W , keeping upper left corner constant",
"func":1
},
{
"ref":"vipy.image.ImageCategories.maxsquare",
"url":11,
"doc":"Crop image of size (HxW) to (max(H,W), max(H,W with zeropadding or (S,S) if provided, keeping upper left corner constant",
"func":1
},
{
"ref":"vipy.image.ImageCategories.maxmatte",
"url":11,
"doc":"Crop image of size (HxW) to (max(H,W), max(H,W with balanced zeropadding forming a letterbox with top/bottom matte or pillarbox with left/right matte",
"func":1
},
{
"ref":"vipy.image.ImageCategories.centersquare",
"url":11,
"doc":"Crop image of size (NxN) in the center, such that N=min(width,height), keeping the image centroid constant",
"func":1
},
{
"ref":"vipy.image.ImageCategories.centercrop",
"url":11,
"doc":"Crop image of size (height x width) in the center, keeping the image centroid constant",
"func":1
},
{
"ref":"vipy.image.ImageCategories.cornercrop",
"url":11,
"doc":"Crop image of size (height x width) from the upper left corner",
"func":1
},
{
"ref":"vipy.image.ImageCategories.fliplr",
"url":11,
"doc":"Mirror the image buffer about the vertical axis - Not idempotent",
"func":1
},
{
"ref":"vipy.image.ImageCategories.flipud",
"url":11,
"doc":"Mirror the image buffer about the horizontal axis - Not idempotent",
"func":1
},
{
"ref":"vipy.image.ImageCategories.imagebox",
"url":11,
"doc":"Return the bounding box for the image rectangle",
"func":1
},
{
"ref":"vipy.image.ImageCategories.border_mask",
"url":11,
"doc":"Return a binary uint8 image the same size as self, with a border of pad pixels in width or height around the edge",
"func":1
},
{
"ref":"vipy.image.ImageCategories.affine_transform",
"url":11,
"doc":"Apply a 3x3 affine geometric transformation to the image. Args: - A [np.ndarray]: 3x3 affine geometric transform from  vipy.geometry.affine_transform - border [str]: 'zero' or 'replicate' to handle elements outside the image rectangle after transformation Returns: - This object with only the array transformed  note The image will be loaded and converted to float() prior to applying the affine transformation.  note This will transform only the pixels",
"func":1
},
{
"ref":"vipy.image.ImageCategories.rotate",
"url":11,
"doc":"Apply a rotation in radians to the pixels, with origin in upper left",
"func":1
},
{
"ref":"vipy.image.ImageCategories.rotate_by_exif",
"url":11,
"doc":"Apply a rotation as specified in the 'Orientation' field EXIF metadata",
"func":1
},
{
"ref":"vipy.image.ImageCategories.rgb",
"url":11,
"doc":"Convert the image buffer to three channel RGB uint8 colorspace",
"func":1
},
{
"ref":"vipy.image.ImageCategories.color_transform",
"url":11,
"doc":"Transform the image buffer from the current  vipy.image.Image.colorspace to the provided colorspace",
"func":1
},
{
"ref":"vipy.image.ImageCategories.colorspace_like",
"url":11,
"doc":"Convert the image buffer to have the same colorspace as the provided image",
"func":1
},
{
"ref":"vipy.image.ImageCategories.rgba",
"url":11,
"doc":"Convert the image buffer to four channel RGBA uint8 colorspace",
"func":1
},
{
"ref":"vipy.image.ImageCategories.hsv",
"url":11,
"doc":"Convert the image buffer to three channel HSV uint8 colorspace",
"func":1
},
{
"ref":"vipy.image.ImageCategories.bgr",
"url":11,
"doc":"Convert the image buffer to three channel BGR uint8 colorspace",
"func":1
},
{
"ref":"vipy.image.ImageCategories.bgra",
"url":11,
"doc":"Convert the image buffer to four channel BGR uint8 colorspace",
"func":1
},
{
"ref":"vipy.image.ImageCategories.float",
"url":11,
"doc":"Convert the image buffer to float32",
"func":1
},
{
"ref":"vipy.image.ImageCategories.greyscale",
"url":11,
"doc":"Convert the image buffer to single channel grayscale float32 in range [0,1]",
"func":1
},
{
"ref":"vipy.image.ImageCategories.grayscale",
"url":11,
"doc":"Alias for greyscale()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.grey",
"url":11,
"doc":"Alias for greyscale()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.gray",
"url":11,
"doc":"Alias for greyscale()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.luminance",
"url":11,
"doc":"Convert the image buffer to single channel uint8 in range [0,255] corresponding to the luminance component",
"func":1
},
{
"ref":"vipy.image.ImageCategories.lum",
"url":11,
"doc":"Alias for luminance()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.jet",
"url":11,
"doc":"Apply jet colormap to greyscale image and save as RGB",
"func":1
},
{
"ref":"vipy.image.ImageCategories.rainbow",
"url":11,
"doc":"Apply rainbow colormap to greyscale image and convert to RGB",
"func":1
},
{
"ref":"vipy.image.ImageCategories.hot",
"url":11,
"doc":"Apply hot colormap to greyscale image and convert to RGB",
"func":1
},
{
"ref":"vipy.image.ImageCategories.bone",
"url":11,
"doc":"Apply bone colormap to greyscale image and convert to RGB",
"func":1
},
{
"ref":"vipy.image.ImageCategories.saturate",
"url":11,
"doc":"Saturate the image buffer to be clipped between [min,max], types of min/max are specified by _array type",
"func":1
},
{
"ref":"vipy.image.ImageCategories.intensity",
"url":11,
"doc":"Convert image to float32 with [min,max] to range [0,1], force colormap to be 'float'. Equivalent to self.mat2gray()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.mat2gray",
"url":11,
"doc":"Convert the image buffer so that [min,max] -> [0,1], forces conversion to 'float' colorspace. This does not change the number of color channels",
"func":1
},
{
"ref":"vipy.image.ImageCategories.gain",
"url":11,
"doc":"Elementwise multiply gain to image array, Gain should be broadcastable to array(). This forces the colospace to 'float'",
"func":1
},
{
"ref":"vipy.image.ImageCategories.bias",
"url":11,
"doc":"Add a bias to the image array. Bias should be broadcastable to array(). This forces the colorspace to 'float'",
"func":1
},
{
"ref":"vipy.image.ImageCategories.normalize",
"url":11,
"doc":"Apply a multiplicative gain g and additive bias b, such that self.array()  gain self.array() + bias. This is useful for applying a normalization of an image prior to calling  vipy.image.Image.torch . The following operations are equivalent.   im = vipy.image.RandomImage() im.normalize(1/255.0, 0.5)  im.gain(1/255.0).bias(-0.5)    note This will force the colorspace to 'float'",
"func":1
},
{
"ref":"vipy.image.ImageCategories.additive_noise",
"url":11,
"doc":"Apply uniform random additive noise in the given range to the given HSV color channels. Image will be converted to HSV prior to applying noise.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.mean",
"url":11,
"doc":"Mean over all pixels",
"func":1
},
{
"ref":"vipy.image.ImageCategories.meanchannel",
"url":11,
"doc":"Mean per channel over all pixels. If channel k is provided, return just the mean for that channel",
"func":1
},
{
"ref":"vipy.image.ImageCategories.closeall",
"url":11,
"doc":"Close all open figure windows",
"func":1
},
{
"ref":"vipy.image.ImageCategories.close",
"url":11,
"doc":"Close the requested figure number, or close all of fignum=None",
"func":1
},
{
"ref":"vipy.image.ImageCategories.show",
"url":11,
"doc":"Display image on screen in provided figure number (clone and convert to RGB colorspace to show), return object",
"func":1
},
{
"ref":"vipy.image.ImageCategories.save",
"url":11,
"doc":"Save the current image to a new filename and return the image object",
"func":1
},
{
"ref":"vipy.image.ImageCategories.pkl",
"url":11,
"doc":"save the object to a pickle file and return the object, useful for intermediate saving in long fluent chains",
"func":1
},
{
"ref":"vipy.image.ImageCategories.pklif",
"url":11,
"doc":"Save the object to the provided pickle file only if b=True. Uuseful for conditional intermediate saving in long fluent chains",
"func":1
},
{
"ref":"vipy.image.ImageCategories.saveas",
"url":11,
"doc":"Save current buffer (not including drawing overlays) to new filename and return filename. If filename is not provided, use a temporary JPEG filename.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.saveastmp",
"url":11,
"doc":"Save current buffer to temp JPEG filename and return filename. Alias for savetmp()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.savetmp",
"url":11,
"doc":"Save current buffer to temp JPEG filename and return filename. Alias for saveastmp()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.tocache",
"url":11,
"doc":"Save current buffer to temp JPEG filename in the VIPY cache and return filename.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.base64",
"url":11,
"doc":"Export a base64 encoding of the image suitable for embedding in an html page",
"func":1
},
{
"ref":"vipy.image.ImageCategories.ascii",
"url":11,
"doc":"Export a base64 ascii encoding of the image suitable for embedding in an  tag",
"func":1
},
{
"ref":"vipy.image.ImageCategories.html",
"url":11,
"doc":"Export a base64 encoding of the image suitable for embedding in an html page, enclosed in  tag Returns: -string:  containing base64 encoded JPEG and alt text with lazy loading",
"func":1
},
{
"ref":"vipy.image.ImageCategories.annotate",
"url":11,
"doc":"Change pixels of this image to include rendered annotation and return an image object",
"func":1
},
{
"ref":"vipy.image.ImageCategories.savefig",
"url":11,
"doc":"Save last figure output from self.show() with drawing overlays to provided filename and return filename",
"func":1
},
{
"ref":"vipy.image.ImageCategories.map",
"url":11,
"doc":"Apply lambda function to our numpy array img, such that newimg=f(img), then replace newimg -> self.array(). The output of this lambda function must be a numpy array and if the channels or dtype changes, the colorspace is set to 'float'",
"func":1
},
{
"ref":"vipy.image.ImageCategories.downcast",
"url":11,
"doc":"Cast the class to the base class (vipy.image.Image)",
"func":1
},
{
"ref":"vipy.image.ImageCategories.perceptualhash",
"url":11,
"doc":"Perceptual differential hash function This function converts to greyscale, resizes with linear interpolation to small image based on desired bit encoding, compute vertical and horizontal gradient signs. Args: bits: [int] longer hashes have lower TAR (true accept rate, some near dupes are missed), but lower FAR (false accept rate), shorter hashes have higher TAR (fewer near-dupes are missed) but higher FAR (more non-dupes are declared as dupes). asbinary: [bool] If true, return a binary array asbytes: [bool] if true return a byte array Returns: A hash string encoding the perceptual hash such that  vipy.image.Image.perceptualhash_distance can be used to compute a hash distance asbytes: a bytes array asbinary: a numpy binary array  notes - Can be used for near duplicate detection by unpacking the returned hex string to binary and computing hamming distance, or performing hamming based nearest neighbor indexing. Equivalently,  vipy.image.Image.perceptualhash_distance . - The default packed hex output can be converted to binary as: np.unpackbits(bytearray().fromhex(h)",
"func":1
},
{
"ref":"vipy.image.ImageCategories.perceptualhash_distance",
"url":11,
"doc":"Hamming distance between two perceptual hashes",
"func":1
},
{
"ref":"vipy.image.ImageCategories.rot90cw",
"url":11,
"doc":"Rotate the scene 90 degrees clockwise",
"func":1
},
{
"ref":"vipy.image.ImageCategories.rot90ccw",
"url":11,
"doc":"Rotate the scene 90 degrees counterclockwise",
"func":1
},
{
"ref":"vipy.image.ImageCategories.face_detection",
"url":11,
"doc":"Detect faces in the scene, add as objects, return new scene with just faces Args: mindim [int]: The minimum dimension for downsampling the image for face detection. Will be upsampled back to native resolution prior to return union [bool]: Whether to return a scene with just faces or the union of the existing scene and the new faces Returns A  vipy.image.Scene object with all detected faces or the union of faces and all objects in self  note This method uses a CPU-only pretrained face detector. This is convenient, but slow. See the heyvi package for optimized GPU batch processing for faster operation.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.person_detection",
"url":11,
"doc":"Detect only people in the scene, add as objects, return new scene with just people Args: mindim [int]: The minimum dimension for downsampling the image for person detection. Will be upsampled back to native resolution prior to return union [bool]: Whether to return a scene with just people or the union of the existing scene and the new people conf [float]: A real value between [0,1] of the minimum confidence for person detection Returns A  vipy.image.Scene object with all detected people or the union of people and all objects in self  note This method uses a CPU-only pretrained person detector. This is convenient, but slow. See the heyvi package for optimized GPU batch processing for faster operation.",
"func":1
},
{
"ref":"vipy.image.ImageCategories.faceblur",
"url":11,
"doc":"Replace pixels for all detected faces with  vipy.image.Scene.blurmask , add locations of detected faces into attributes. Args: radius [int]: The radius of pixels for  vipy.image.Scene.blurmask mindim [int]: The minimum dimension for downsampling the image for face detection. Will be upsampled prior to pixelize. Returns: A  vipy.image.Image object with a pixel buffer with all faces pixelized, with faceblur attribute set in  vipy.image.Image.metadata showing the locations of the blurred faces.  notes - This method uses a CPU-only pretrained torch network for face detection from the heyvi visual analytics package, which is re-initialized on each call to this method. - For batch operations on many images, it is preferred to set up the detection network once, then calling many images sequentially. - To retain boxes, use self.face_detection().blurmask()",
"func":1
},
{
"ref":"vipy.image.ImageCategories.facepixelize",
"url":11,
"doc":"Replace pixels for all detected faces with  vipy.image.Scene.pixelize , add locations of detected faces into attributes. Args: radius [int]: The radius of pixels for  vipy.image.Scene.radius mindim [int]: The minimum dimension for downsampling the image for face detection. Will be upsampled prior to pixelize. Returns: A  vipy.image.Image object with a pixel buffer with all faces pixelized, with facepixelize attribute set in  vipy.image.Image.metadata showing the locations of the blurred faces.  notes - This method uses a CPU-only pretrained torch network for face detection from the heyvi visual analytics package, which is re-initialized on each call to this method. - For batch operations on many images, it is preferred to set up the detection network once, then calling many images sequentially. - To retain boxes, use self.face_detection().pixelize()",
"func":1
},
...
{
"ref":"vipy.image.DetectionImage.exif",
"url":11,
"doc":"Return the EXIF meta-data in filename as a dictionary. Included non-base EXIF data if extended=True. Returns empty dictionary if no EXIF exists. Triggers download.",
"func":1
},
...
{
"ref":"vipy.image.DetectionImage.mindimn",
"url":11,
"doc":"Frequently used shortcut for mindim(dim, interp='nearest')",
"func":1
},
...
{
"ref":"vipy.image.DetectionImage.rotate_by_exif",
"url":11,
"doc":"Apply a rotation as specified in the 'Orientation' field EXIF metadata",
"func":1
},
...
{
"ref":"vipy.image.DetectionImage.color_transform",
"url":11,
"doc":"Transform the image buffer from the current  vipy.image.Image.colorspace to the provided colorspace",
"func":1
},
{
"ref":"vipy.image.DetectionImage.colorspace_like",
"url":11,
"doc":"Convert the image buffer to have the same colorspace as the provided image",
"func":1
},
...
{
"ref":"vipy.image.DetectionImage.probability",
"url":11,
"doc":"Return float image in the range [0,1] such that all elements sum to one",
"func":1
},
...
{
"ref":"vipy.image.DetectionImage.tocache",
"url":11,
"doc":"Save current buffer to temp JPEG filename in the VIPY cache and return filename.",
"func":1
},
...
{
"ref":"vipy.image.DetectionImage.face_detection",
"url":11,
"doc":"Detect faces in the scene, add as objects, return new scene with just faces Args: mindim [int]: The minimum dimension for downsampling the image for face detection. Will be upsampled back to native resolution prior to return union [bool]: Whether to return a scene with just faces or the union of the existing scene and the new faces Returns A  vipy.image.Scene object with all detected faces or the union of faces and all objects in self  note This method uses a CPU-only pretrained face detector. This is convenient, but slow. See the heyvi package for optimized GPU batch processing for faster operation.",
"func":1
},
{
"ref":"vipy.image.DetectionImage.person_detection",
"url":11,
"doc":"Detect only people in the scene, add as objects, return new scene with just people Args: mindim [int]: The minimum dimension for downsampling the image for person detection. Will be upsampled back to native resolution prior to return union [bool]: Whether to return a scene with just people or the union of the existing scene and the new people conf [float]: A real value between [0,1] of the minimum confidence for person detection Returns A  vipy.image.Scene object with all detected people or the union of people and all objects in self  note This method uses a CPU-only pretrained person detector. This is convenient, but slow. See the heyvi package for optimized GPU batch processing for faster operation.",
"func":1
},
...
{
"ref":"vipy.image.squareowl",
"url":11,
"doc":"Return a superb owl with no objects, cropped square at 512x512 resolution",
"func":1
},
{
"ref":"vipy.image.Owl",
"url":11,
"doc":"Return superb owl centersquare, mindim=512",
"func":1
},
{
...
{
"ref":"vipy.video.Video.tocache",
"url":17,
"doc":"Call  vipy.video.Video.saveas using a new temporary video file in VIPY cache, and return the video object with this new filename",
"func":1
},
{
...
{
"ref":"vipy.video.VideoCategory.tocache",
"url":17,
"doc":"Call  vipy.video.Video.saveas using a new temporary video file in VIPY cache, and return the video object with this new filename",
"func":1
},
...
{
"ref":"vipy.data.emnist",
"url":23,
"doc":""
},
{
"ref":"vipy.data.emnist.EMNIST",
"url":23,
"doc":"download URLS above to outdir, then run export()"
},
{
"ref":"vipy.data.emnist.EMNIST.letters_train",
"url":23,
"doc":"",
"func":1
},
{
"ref":"vipy.data.emnist.EMNIST.letters_test",
"url":23,
"doc":"",
"func":1
},
{
"ref":"vipy.data.emnist.EMNIST.letters",
"url":23,
"doc":"",
"func":1
},
{
"ref":"vipy.data.emnist.EMNIST.digits_train",
"url":23,
"doc":"",
"func":1
},
{
"ref":"vipy.data.emnist.EMNIST.digits_test",
"url":23,
"doc":"",
"func":1
},
{
"ref":"vipy.data.emnist.EMNIST.digits",
"url":23,
"doc":"",
"func":1
},
{
"ref":"vipy.data.emnist.EMNIST.trainset",
"url":23,
"doc":"",
"func":1
},
{
"ref":"vipy.data.emnist.EMNIST.testset",
"url":23,
"doc":"",
"func":1
},
...
"url":28,
"doc":"Return the dataset as a set",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.istype",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.archive",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.save",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.class_to_index",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.index_to_class",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.merge",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.takefilter",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.jsondir",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
{
...
"url":28,
"doc":"Load the entire dataset into memory. This is useful for creating in-memory datasets from lazy load datasets",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.take",
"url":28,
"doc":"Randomlly Take n elements from the dataset, and return a dataset. If seed=int, take will return the same results each time.",
"func":1
},
{
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.shuffle",
"url":28,
"doc":"Randomly permute elements in this dataset according to a shuffler protocol set with shuffler()",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.chunk",
"url":28,
"doc":"Yield n chunks as dataset. Last chunk will be ragged",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.minibatch",
"url":28,
"doc":"Yield list chunks of size n of this dataset. Last chunk will be ragged if ragged=True, else skipped",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.split_by_videoid",
"url":28,
...
"url":28,
"doc":"Split the dataset into the requested fractions. Args: trainfraction [float]: fraction of dataset for training set valfraction [float]: fraction of dataset for validation set testfraction [float]: fraction of dataset for test set seed [int]: random seed for determinism. Set to None for random. withtest: If true, return (trainset, valset, testset) even if testset is None Returns: (trainset, valset, testset) if withtest=True else (trainset, valest) if testfraction=0",
"func":1
},
{
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.multilabel_inverse_frequency_weight",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.density",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.to_torch",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.to_torch_tensordir",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.tohtml",
"url":28,
...
{
"ref":"vipy.data.oxford_flowers_102.Flowers102.video_montage",
"url":28,
...
{
"ref":"vipy.data.inaturalist.iNaturalist2021.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
...
{
"ref":"vipy.data.inaturalist.iNaturalist2021.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
...
{
"ref":"vipy.data.inaturalist.iNaturalist2021.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
...
{
"ref":"vipy.data.inaturalist.iNaturalist2021.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.data.inaturalist.iNaturalist2021.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.data.inaturalist.iNaturalist2021.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.inaturalist.iNaturalist2021.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
...
{
"ref":"vipy.data.visualgenome.VisualGenome.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
...
{
"ref":"vipy.data.visualgenome.VisualGenome.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
...
{
"ref":"vipy.data.visualgenome.VisualGenome.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
...
{
"ref":"vipy.data.visualgenome.VisualGenome.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.data.visualgenome.VisualGenome.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.data.visualgenome.VisualGenome.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.visualgenome.VisualGenome.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
...
{
"ref":"vipy.data.food101.Food101.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.food101.Food101.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.food101.Food101.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
...
{
"ref":"vipy.data.food101.Food101.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.food101.Food101.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.food101.Food101.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.food101.Food101.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.food101.Food101.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.food101.Food101.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.food101.Food101.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.food101.Food101.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.food101.Food101.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.food101.Food101.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.food101.Food101.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.food101.Food101.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.food101.Food101.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.food101.Food101.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
...
{
"ref":"vipy.data.food101.Food101.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.food101.Food101.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.food101.Food101.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
...
{
"ref":"vipy.data.food101.Food101.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.food101.Food101.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.data.food101.Food101.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.data.food101.Food101.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.food101.Food101.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.food101.Food101.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.food101.Food101.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.food101.Food101.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.food101.Food101.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.food101.Food101.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.food101.Food101.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.food101.Food101.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.food101.Food101.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.food101.Food101.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
...
{
"ref":"vipy.data.caltech256.Caltech256.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
...
{
"ref":"vipy.data.caltech256.Caltech256.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
...
{
"ref":"vipy.data.caltech256.Caltech256.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
...
{
"ref":"vipy.data.caltech256.Caltech256.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.data.caltech256.Caltech256.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.data.caltech256.Caltech256.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.caltech256.Caltech256.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
...
{
"ref":"vipy.data.stanford_cars.StanfordCars.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
...
{
"ref":"vipy.data.stanford_cars.StanfordCars.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
...
{
"ref":"vipy.data.stanford_cars.StanfordCars.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
...
{
"ref":"vipy.data.stanford_cars.StanfordCars.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.data.stanford_cars.StanfordCars.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.data.stanford_cars.StanfordCars.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.stanford_cars.StanfordCars.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
...
{
"ref":"vipy.data.caltech101.Caltech101.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
...
{
"ref":"vipy.data.caltech101.Caltech101.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
...
{
"ref":"vipy.data.caltech101.Caltech101.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
...
{
"ref":"vipy.data.caltech101.Caltech101.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.data.caltech101.Caltech101.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.data.caltech101.Caltech101.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.caltech101.Caltech101.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
...
"url":41,
"doc":"By downloading, you agree to the ImageNet terms: https: image-net.org/download-images.php term"
},
{
...
"url":41,
"doc":"ImageNet Classification, trainset",
"func":1
},
{
...
"url":41,
"doc":"ImageNet localization, imageset = {train, val}",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized",
"url":41,
"doc":"https: image-net.org/download-images.php, imagenet-21K 2021 release (resized)"
},
{
...
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
...
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
...
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
...
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K_Resized.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
...
"url":41,
"doc":"https: image-net.org/download-images.php, imagenet-21K 2021 winter release"
},
{
...
{
"ref":"vipy.data.imagenet.Imagenet21K.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
...
{
"ref":"vipy.data.imagenet.Imagenet21K.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
...
{
"ref":"vipy.data.imagenet.Imagenet21K.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
...
{
"ref":"vipy.data.imagenet.Imagenet21K.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.data.imagenet.Imagenet21K.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.data.imagenet.Imagenet21K.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.imagenet.Imagenet21K.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
...
{
"ref":"vipy.data.coco.Detection_TrainVal_2014",
"url":44,
"doc":"Project: https: cocodataset.org"
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.id",
"url":28,
"doc":"Set or return the dataset id",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.list",
"url":28,
"doc":"Return the dataset as a list",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.set",
"url":28,
"doc":"Return the dataset as a set",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.clone",
"url":28,
"doc":"Return a deep copy of the dataset",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.filter",
"url":28,
"doc":"In place filter with lambda function f",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.takelist",
"url":28,
"doc":"Take n elements of selected category and return list. The elements are not cloned.",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.load",
"url":28,
"doc":"Load the entire dataset into memory. This is useful for creating in-memory datasets from lazy load datasets",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.take",
"url":28,
"doc":"Randomlly Take n elements from the dataset, and return a dataset. If seed=int, take will return the same results each time.",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.takeone",
"url":28,
"doc":"Randomly take one element from the dataset and return a singleton",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.shuffle",
"url":28,
"doc":"Randomly permute elements in this dataset according to a shuffler protocol set with shuffler()",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.chunk",
"url":28,
"doc":"Yield n chunks as dataset. Last chunk will be ragged",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.minibatch",
"url":28,
"doc":"Yield list chunks of size n of this dataset. Last chunk will be ragged if ragged=True, else skipped",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.split",
"url":28,
"doc":"Split the dataset into the requested fractions. Args: trainfraction [float]: fraction of dataset for training set valfraction [float]: fraction of dataset for validation set testfraction [float]: fraction of dataset for test set seed [int]: random seed for determinism. Set to None for random. withtest: If true, return (trainset, valset, testset) even if testset is None Returns: (trainset, valset, testset) if withtest=True else (trainset, valest) if testfraction=0",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.map",
"url":28,
"doc":"Distributed map. To perform this in parallel across four processes:   D = vipy.dataset.Dataset( .) with vipy.globals.parallel(4): D.map(lambda v:  .)   Args: f_map: [lambda] The lambda function to apply in parallel to all elements in the dataset. This must return a JSON serializable object model: [torch.nn.Module] The model to scatter to all workers dst: [str] The ID to give to the resulting dataset id: [str] The ID to give to the resulting dataset (parameter alias for dst) strict: [bool] If true, raise exception on map failures, otherwise the map will return None for failed elements ascompleted: [bool] If true, return elements as they complete ordered: [bool] If true, preserve the order of objects in dataset as returned from distributed processing Returns: A  vipy.dataset.Dataset containing the elements f_map(v). This operation is order preserving if ordered=True.  note - This dataset must contain vipy objects of types defined in  vipy.util.class_registry or JSON serializable objects - Serialization of large datasets can take a while, kick it off to a distributed dask scheduler and go get lunch - This method uses dask distributed and  vipy.batch.Batch operations - All vipy objects are JSON serialized prior to parallel map to avoid reference cycle garbage collection which can introduce instabilities - Due to chunking, all error handling is caught by this method. Use  vipy.batch.Batch to leverage dask distributed futures error handling. - Operations must be chunked and serialized because each dask task comes with overhead, and lots of small tasks violates best practices - Serialized results are deserialized by the client and returned a a new dataset",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.count",
"url":28,
"doc":"Counts for each label. Args: f: [lambda] if provided, count the number of elements that return true. This is the same as len(self.filter(f without modifying the dataset. Returns: A dictionary of counts per category [if f is None] A length of elements that satisfy f(v) = True [if f is not None]",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.zip",
"url":28,
"doc":"Zip two datasets. Equivalent to zip(self, other).   for (d1,d2) in D1.zip(D2, sortkey=lambda v: v.instanceid( : pass for (d1, d2) in zip(D1, D2): pass   Args: other: [ vipy.dataset.Dataset ] sortkey: [lambda] sort both datasets using the provided sortkey lambda. Returns: Generator for the tuple sequence ( (self[0], other[0]), (self[1], other[1]),  . )",
"func":1
},
{
"ref":"vipy.data.coco.Detection_TrainVal_2014.sort",
"url":28,
"doc":"Sort the dataset in-place using the sortkey lambda function",
"func":1
},
...
{
"ref":"vipy.data.places.Places356",
"url":48,
"doc":"Project: http: places2.csail.mit.edu/download-private.html"
},
{
"ref":"vipy.data.places.Places356.trainset",
"url":48,
"doc":"",
"func":1
},
{
"ref":"vipy.data.places.Places356.valset",
"url":48,
"doc":"",
"func":1
},
...
{
"ref":"vipy.data.lfw.LFW.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
...
{
"ref":"vipy.data.lfw.LFW.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
...
{
"ref":"vipy.data.lfw.LFW.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
...
{
"ref":"vipy.data.lfw.LFW.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.data.lfw.LFW.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.data.lfw.LFW.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.lfw.LFW.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
...
{
"ref":"vipy.data.objectnet.Objectnet.tolist",
"url":28,
"doc":"Alias for self.list()",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.flatten",
"url":28,
"doc":"Convert dataset stored as a list of lists into a flat list",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.istype",
"url":28,
"doc":"Return True if the all elements (or just the first element if strict=False) in the dataset are of type 'validtype'",
"func":1
},
...
{
"ref":"vipy.data.objectnet.Objectnet.archive",
"url":28,
"doc":"Create a archive file for this dataset. This will be archived as: /path/to/tarfile.{tar.gz|.tgz|.bz2} tarfilename tarfilename.{json|pkl} mediadir/ video.mp4 extras1.ext extras2.ext Args: tarfile: /path/to/tarfilename.tar.gz delprefix: the absolute file path contained in the media filenames to be removed. If a video has a delprefix='/a/b' then videos with path /a/b/c/d.mp4' -> 'c/d.mp4', and {JSON|PKL} will be saved with relative paths to mediadir. This may be a list of delprefixes. mediadir: the subdirectory name of the media to be contained in the archive. Usually \"videos\". extrafiles: list of tuples or singletons [(abspath, filename_in_archive_relative_to_root), 'file_in_root_and_in_pwd',  .], novideos [bool]: generate a tarball without linking videos, just annotations md5 [bool]: If True, generate the MD5 hash of the tarball using the system \"md5sum\", or if md5='vipy' use a slower python only md5 hash castas [class]: This should be a vipy class that the vipy objects should be cast to prior to archive. This is useful for converting priveledged superclasses to a base class prior to export. tmpdir: The path to the temporary directory for construting this dataset. Defaults to system temp. This directory will be emptied prior to archive. inplace [bool]: If true, modify the dataset in place to prepare it for archive, else make a copy bycategory [bool]: If true, save the annotations in an annotations/ directory by category annotationdir [str]: The subdirectory name of annotations to be contained in the archive if bycategory=True. Usually \"annotations\" or \"json\". Example: - Input files contain /path/to/oldvideos/category/video.mp4 - Output will contain relative paths videos/category/video.mp4   d.archive('out.tar.gz', delprefix='/path/to/oldvideos', mediadir='videos')   Returns: The absolute path to the tarball",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.save",
"url":28,
"doc":"Save the dataset to the provided output filename stored as pkl or json Args: outfile: [str]: The /path/to/out.pkl or /path/to/out.json nourl: [bool]: If true, remove all URLs from the media (if present) castas: [type]: Cast all media to the provided type. This is useful for downcasting to  vipy.video.Scene from superclasses relpath: [bool]: If true, define all file paths in objects relative to the /path/to in /path/to/out.json sanitize: [bool]: If trye, call sanitize() on all objects to remove all private attributes with prepended '__' strict: [bool]: Unused significant_digits: [int]: Assign the requested number of significant digits to all bounding boxes in all tracks. This requires dataset of  vipy.video.Scene noemail: [bool]: If true, scrub the attributes for emails and replace with a hash flush: [bool]: If true, flush the object buffers prior to save bycategory [bool[: If trye, then save the dataset to the provided output filename pattern outfile='/path/to/annotations/ .json' where the wildcard is replaced with the category name Returns: This dataset that is quivalent to vipy.dataset.Dataset('/path/to/outfile.json')",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.classlist",
"url":28,
"doc":"Return a sorted list of categories in the dataset",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.classes",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.categories",
"url":28,
"doc":"Alias for classlist",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.num_classes",
"url":28,
"doc":"Return the number of unique categories in this dataset",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.num_labels",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.num_categories",
"url":28,
"doc":"Alias for num_classes",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.class_to_index",
"url":28,
"doc":"Return a dictionary mapping the unique classes to an integer index. This is useful for defining a softmax index ordering for categorization",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.index_to_class",
"url":28,
"doc":"Return a dictionary mapping an integer index to the unique class names. This is the inverse of class_to_index, swapping keys and values",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.label_to_index",
"url":28,
"doc":"Alias for class_to_index",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.countby",
"url":28,
"doc":"Count the number of elements that return the same value from the lambda function",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.replace",
"url":28,
"doc":"Replace elements in self with other with equality detemrined by the key lambda function",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.merge",
"url":28,
"doc":"Merge a dataset union into a single subdirectory with symlinked media ready to be archived.   D1 = vipy.dataset.Dataset('/path1/dataset.json') D2 = vipy.dataset.Dataset('/path2/dataset.json') D3 = D1.union(D2).merge(outdir='/path3')   Media in D1 are in /path1, media in D2 are in /path2, media in D3 are all symlinked to /path3. We can now create a tarball for D3 with all of the media files in the same relative path.",
"func":1
},
...
{
"ref":"vipy.data.objectnet.Objectnet.takefilter",
"url":28,
"doc":"Apply the lambda function f and return n elements in a list where the filter returns true Args: f: [lambda] If f(x) returns true, then keep n: [int >= 0] The number of elements to take Returns: [n=0] Returns empty list [n=1] Returns singleton element [n>1] Returns list of elements of at most n such that each element f(x) is True",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.jsondir",
"url":28,
"doc":"Export all objects to a directory of JSON files. Usage:   D = vipy.dataset.Dataset( .).jsondir('/path/to/jsondir') D = vipy.util.load('/path/to/jsondir')  recursively discover and lazy load all json files   Args: outdir [str]: The root directory to store the JSON files verbose [bool]: If True, print the save progress rekey [bool] If False, use the instance ID of the vipy object as the filename for the JSON file, otherwise assign a new UUID_dataset-index bycategory [bool]: If True, use the JSON structure '$OUTDIR/$CATEGORY/$INSTANCEID.json' byfilename [bool]: If True, use the JSON structure '$FILENAME.json' where $FILENAME is the underlying media filename of the vipy object abspath [bool]: If true, store absolute paths to media in JSON. If false, store relative paths to media from JSON directory Returns: outdir: The directory containing the JSON files.",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.tojsondir",
"url":28,
"doc":"Alias for  vipy.dataset.Dataset.jsondir ",
"func":1
},
...
{
"ref":"vipy.data.objectnet.Objectnet.take_per_category",
"url":28,
"doc":"Random;y take n elements per category and return a shallow cloned dataset",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.data.objectnet.Objectnet.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.data.objectnet.Objectnet.synonym",
"url":28,
"doc":"Convert all categories in the dataset using the provided synonym dictionary mapping",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.percentage",
"url":28,
"doc":"Fraction of dataset for each label",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.multilabel_inverse_frequency_weight",
"url":28,
"doc":"Return an inverse frequency weight for multilabel activities, where label counts are the fractional label likelihood within a clip",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.inverse_frequency_weight",
"url":28,
"doc":"Return inverse frequency weight for categories in dataset. Useful for unbalanced class weighting during training",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.video_duration_in_seconds",
"url":28,
"doc":"Duration of activities",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.density",
"url":28,
"doc":"Compute the frequency that each video ID is represented. This counts how many activities are in a video, truncated at max",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.to_torch",
"url":28,
"doc":"Return a torch dataset that will apply the lambda function f_video_to_tensor to each element in the dataset on demand",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.to_torch_tensordir",
"url":28,
"doc":"Return a TorchTensordir dataset that will load a pkl.bz2 file that contains one of n_augmentations (tensor, label) pairs. This is useful for fast loading of datasets that contain many videos.",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.tohtml",
"url":28,
"doc":"Generate a standalone HTML file containing quicklooks for each annotated activity in dataset, along with some helpful provenance information for where the annotation came from",
"func":1
},
{
"ref":"vipy.data.objectnet.Objectnet.video_montage",
"url":28,
"doc":"30x50 activity montage, each 64x64 elements. Args: outfile: [str] The name of the outfile for the video. Must have a valid video extension. gridrows: [int, None] The number of rows to include in the montage. If None, infer from other args gridcols: [int] The number of columns in the montage mindim: [int] The square size of each video in the montage bycategory: [bool] Make the video such that each row is a category category: [str, list] Make the video so that every element is of category. May be a list of more than one categories annotate: [bool] If true, include boxes and captions for objects and activities trackcrop: [bool] If true, center the video elements on the tracks with dilation factor 1.5 transpose: [bool] If true, organize categories columnwise, but still return a montage of size (gridrows, gridcols) max_duration: [float] If not None, then set a maximum duration in seconds for elements in the video. If None, then the max duration is the duration of the longest element. Returns: A clone of the dataset containing the selected videos for the montage, ordered rowwise in the montage  notes - If a category does not contain the required number of elements for bycategory, it is removed prior to visualization - Elements are looped if they exit prior to the end of the longest video (or max_duration)",
"func":1
},
...
{
"ref":"vipy.dataset.Dataset.shuffler",
"url":28,
"doc":"Specify a shuffler protocol. >>> D.shuffler('uniform') >>> D.shuffer(uniform=True) >>> D.shuffle() Args: uniform [bool]: shuffle element uniformly at random pairwise [bool]: elements are assumed to be pairwise similarities, such that the category() method returns an id for each positive pair. Shuffle keeping positive pairs as minibatch neighbors. Returns: self if a new shuffler is requested, otherwise return a lambda function which shuffles a list. This lambda function is not meant to be used directly, rather exercised by shuffle",
"func":1
},
...
{
"ref":"vipy.dataset.Dataset.split_by_videoid",
"url":28,
"doc":"Split the dataset by category by fraction so that video IDs are never in the same set",
"func":1
},
...
{
"ref":"vipy.util.trycatcher",
"url":56,
"doc":"Call the function f with the provided arguments, and return (result) on success and (None) if there is any thrown exception. Useful for parallel processing",
"func":1
},
{
"ref":"vipy.util.catchif",
"url":56,
"doc":"Call the function f with the provided arguments, and return (result) on success and (None) if there is any thrown exception. Useful for parallel processing. Alias for  vipy.util.trycatcher ",
"func":1
},
{
...
"url":56,
"doc":"randomly permute list order. Permutation is deterministic (same permutation on multiple calls) if specified",
"func":1
},
{
