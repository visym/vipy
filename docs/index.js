...
"url":10,
"doc":"Take one element at random from inlist",
"func":1
},
{
...
"url":11,
"doc":"Randomlly Take n elements from the dataset, and return a dataset if n>1, otherwise return the singleton element. If seed=int, take will return the same results each time.",
"func":1
},
{
...
"url":36,
"doc":"vipy.data.cifar.CIFAR10 class >>> D = vipy.data.cifar.CIFAR10('/path/to/outdir') >>> (x,y) = D.trainset() >>> im = D[0].mindim(512).show()"
},
{
